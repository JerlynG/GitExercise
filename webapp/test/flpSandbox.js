		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1gollayan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1gollayan-display": {
								"semanticObject": "zbtpday5exercise1gollayan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1gollayan",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1gollayan")
								}
							}
						}
					}
